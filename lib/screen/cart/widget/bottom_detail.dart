...
// import 'package:sahashop_customer/app_customer/screen_default/cart/cart_controller.dart';
...
//                     ),
//                   ),
//                   if((cartController.cartData.value.productDiscountAmount ?? 0) != 0)
//                   Padding(
//                     padding: const EdgeInsets.all(15.0),
//                     child: Row(
//                       mainAxisAlignment:
...
//                     ),
//                   ),
//                   if((cartController.cartData.value.voucherDiscountAmount ?? 0) != 0)
//                   Padding(
//                     padding: const EdgeInsets.all(15.0),
//                     child: Row(
//                       mainAxisAlignment:
...
//                     ),
//                   ),
//                   if((cartController.cartData.value.comboDiscountAmount ?? 0) != 0)
//                   Padding(
//                     padding: const EdgeInsets.all(15.0),
//                     child: Row(
//                       mainAxisAlignment:
